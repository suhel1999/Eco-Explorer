...
{
    public partial class Form_Harishchandragad : Form
    {
        ...
        public Form_Harishchandragad()
        {
            InitializeComponent();
        }

        public Form_Harishchandragad(string username)
        {
            InitializeComponent();
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(ConnectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand(query, connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@Trek_id", "T109");
