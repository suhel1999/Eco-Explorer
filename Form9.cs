...
{
    public partial class Form_Bhairavgad : Form
    {
        ...
        public Form_Bhairavgad()
        {
            InitializeComponent();
        }
        public Form_Bhairavgad(string username)
        {
            InitializeComponent();
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(ConnectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand(query, connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@Trek_id", "T103");
        ...
        private void Form_Bhairavgad_Load(object sender, EventArgs e)
        {
